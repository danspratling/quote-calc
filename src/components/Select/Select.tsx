...
export const SelectWrapper = ({ label, htmlFor, className, error, hint, children }: SelectWrapperProps) => {
  return (
    <div className={cn(className)}>
      <label htmlFor={htmlFor} className='mb-2 block text-base font-semibold text-gray-600 dark:text-gray-400'>
        {label}
      </label>
  ...
  return (
    ...
    >
      ...
      <RadixSelect.Portal>
        <RadixSelect.Content
          className={cn(
            'z-50 p-1 min-w-[12rem] shadow-lg rounded-md overflow-hidden flex items-center justify-center',
